...
import itp.team1.jobseeker.DataParsing.CachedServerCalls.ServerCall.PlainServerCall;
import itp.team1.jobseeker.DataParsing.CachedServerCalls.ServerCall.ServerCallMethod;

abstract public class PlainJSONServerCallWithDataParser extends PlainServerCall implements DataParser {
	 ...
	 */
	public PlainJSONServerCallWithDataParser(Context context, String mApiName, ServerCallMethod mMethod, String jSONKey) {	
	 ...
	 */
	public PlainJSONServerCallWithDataParser(Context context, String mApiName, ServerCallMethod mMethod, String [] jSONKeys) {	
		super(context, mApiName, mMethod, null);
		setDataParser(this);
		JSONKeys = jSONKeys;
	};
