...
public class PlainServerCall {
	 ...
	 */
	protected PlainServerResponseHandler mResponseHandler;	
	/**
	 ...
	 */
	public PlainServerCall(Context context, String mApiName, ServerCallMethod mMethod, DataParser dataParser) {
		super();
		this.mApiName = mApiName;
		this.mMethod  = mMethod;
		this.mContext = context;
		if(dataParser != null)
			mResponseHandler = new PlainServerResponseHandler(context,dataParser, mApiName);
	...
	public void SetClientCredentials(String user, String token){
	...
	public void setDataParser(DataParser dataParser){
		mResponseHandler = new PlainServerResponseHandler(mContext,dataParser, mApiName);
	}
